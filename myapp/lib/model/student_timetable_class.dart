...
//           children: [
//             buildRow(['Cell 1', 'Cell 2', 'Cell 3', 'Cell 4', 'Cell 5'])
//           ],
//         ),
//       ),
//     );
...
import 'package:myapp/model/sample_event.dart';
...
class ClassTime extends StatelessWidget {
  ClassTime({Key? key, required this.title}) : super(key: key);
  final String title;
