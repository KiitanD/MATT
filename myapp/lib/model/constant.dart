...
const MONGO_CONN_URL3 =
    "mongodb+srv://Omieibi:iUXEcoZt1hDWYbXI@matt.plnfh.mongodb.net/CourseRegistration?retryWrites=true&w=majority";

const ClassPeriod_Coll =
    "ClassPeriods"; // The collection name we are calling from the db
const Classrooms_Coll = "Classrooms";
...
const CourseList_Coll = "Spring22";
